...
class DiversionChildrenListPage extends StatefulWidget {
  const DiversionChildrenListPage({Key? key}) : super(key: key);

  @override
  State<DiversionChildrenListPage> createState() =>
      _DiversionChildrenListPageState();
}

class _DiversionChildrenListPageState extends State<DiversionChildrenListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Diversion Children List'),
      ),
