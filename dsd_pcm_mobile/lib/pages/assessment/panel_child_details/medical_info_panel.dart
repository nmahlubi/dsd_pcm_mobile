...
class MedicalInfoPanel extends StatelessWidget {
  final List<MedicalHealthDetailDto>? medicalHealthDetailsDto;
  const MedicalInfoPanel({super.key, required this.medicalHealthDetailsDto});
                              ...
                              itemBuilder: (context, int index) {
                                ...
                                return ListTile(
                                    ...
                                    subtitle: Text(
                                        ...
                                        'Allergies  :  ${medicalHealthDetailsDto![index].allergies}',
