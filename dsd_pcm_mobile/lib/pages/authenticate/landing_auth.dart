...
class LandingAuthPage extends StatefulWidget {
  const LandingAuthPage({Key? key, required String title}) : super(key: key);

  @override
  State<LandingAuthPage> createState() => _LandingAuthPageWidgetState();
}

class _LandingAuthPageWidgetState extends State<LandingAuthPage> {
